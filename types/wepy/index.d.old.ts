...
declare namespace wepy {
   ...
   */
  function request(param: RequestParam): Promise<HttpResponse>;
  /**
   * 上传文件
   * 将本地资源上传到开发者服务器
   ...
   */
  function uploadFile(param: UploadParam): Promise<HttpResponse>;
  /**
   * 下载文件
   ...
   */
  function connectSocket(param: ConnectSocketParam): void;
  /**监听 WebSocket 打开 */
  ...
  */
  function sendSocketMessage(message: SocketMessage): void;
  /**接受 WebSocket 消息 */
  function onSocketMessage(callback: (res?: { data: string | ArrayBuffer }) => void): void;
  /**关闭 WebSocket 连接 */
  function closeSocket(param: CloseSocketParam): void;
  /**监听 WebSocket 关闭 */
  function onSocketClose(callback: (res?: any) => void): void;

  // 媒体 API 列表
  /**从相册选择图片 或者拍照 */
  function chooseImage(param: ChooseImageParam): Promise<{
  ...
  // 数据 API 列表
  /**获取本地数据缓存 */
  function getStorage(param: GetStorageParam): Promise<{ data: any }>;
   ...
   */
  function setStorage(param: SetStorageParam): Promise<void>;
 ...
 */
   ...
   */
  function startPullDownRefresh(param: CallbackWithErrMsgParam): never;

  // 开放接口
  /**登录 */
  function login(param?: LoginParam): Promise<LoginResult>;
  /**获取用户信息 */
  function getUserInfo(param: UserInfoParam): void;
  /**发起微信支付 */
  function requestPayment(param: RequestPaymentParam): void;
  /**检查登陆态是否过期 */
  function checkSession(param: CallbackParam): void;
  ...
  // 蓝牙相关
  /**初始化蓝牙适配器 */
  function openBluetoothAdapter(param: CallbackParam): void;
  /**关闭蓝牙模块 调用该方法将断开所有已建立的链接并释放系统资源 */
  function closeBluetoothAdapter(param: CallbackParam): void;
  /**获取本机蓝牙适配器状态 */
  ...
  /**停止搜寻附近的蓝牙外围设备 */
  function stopBluetoothDevicesDiscovery(param: CallbackWithErrMsgParam): void;
  ...
  /**获取系统剪贴板内容 */
  function getClipboardData(param: CallbackParam): void;
  ...
  /**隐藏分享按钮 */
  function hideShareMenu(param: CallbackParam): void;
  /**获取分享详细信息 */
  ...
  /**开始搜索附近的iBeacon设备 */
  function startBeaconDiscovery(param: CallbackWithErrMsgParam): void;
  /**停止搜索附近的iBeacon设备 */
  function stopBeaconDiscovery(param: CallbackWithErrMsgParam): void;
  /**获取所有已搜索到的iBeacon设备 */
  ...
  /**使手机发生较长时间的振动 400ms */
  function vibrateLong(param: CallbackParam): void;
  /**使手机发生较短时间的振动 15ms */
  function vibrateShort(param: CallbackParam): void;
  ...
  /**将页面滚动到目标位置 单位px */
  function pageScrollTo(scrollTop: number): never;
  /**支持小程序修改标题栏颜色 */
